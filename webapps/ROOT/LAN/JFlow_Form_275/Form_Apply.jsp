...
<iframe src="b.jsp" width=100% height=50px></iframe> <!--這裡是iframe,作為置入b.jsp的地方，然後再將b.jsp內容傳到本頁的第一欄-->
<iframe src="b.html" width=100% height=50px></iframe><!--這裡是iframe,作為置入b.html的地方，然後再將b.html內容傳到本頁的最下方input內文-->
<iframe src="c.html" width=100% height=50px></iframe><!--這裡是iframe,作為置入c.html的地方，然後再將c.html內容傳到本頁iframe-->
<iframe src="IP.jsp" width=100% height=50px></iframe><!--這裡是iframe,作為置入IP.jsp的地方，然後再將IP.jsp內容傳到本頁iframe-->
</body>
</html>