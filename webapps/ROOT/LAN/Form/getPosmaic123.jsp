...
String Content="",SqlStr0="",SqlStr02="",floor="",floorno="",speno="",Content2="",Content3="",Content4="",Content5="";
...
Statement stmt2 = conn2.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
	...
	SqlStr0="select  s026_mno,s026_ecr,s026_lan,p014_sname as Namep,p031_mark as Namep2 from  cy@chyusc1: salf026 left join purf014 on s026_lan = p014_speno left join purf031 on s026_lan = p031_box where s026_ecr not matches 'Z*'";
	SqlStr02="select s026_mno,s026_ecr,s026_lan,p014_sname as Namep  from cy2@chyusc1: salf026, purf014 where p014_speno = s026_lan ";
	...
	if(SqlStr0!=""||SqlStr02!="")
	{
		...
		if(SqlStr02!="")
		{
			Rs2=stmt2.executeQuery(SqlStr02);
