...
//,mw07_condition 狀態,申請
   ...
   for(int t=0;t<5;t++)
   {
          String Field1=String.valueOf((t*9)+1);	String Field2=String.valueOf((t*9)+2);
          String Field3=String.valueOf((t*9)+3);	String Field4=String.valueOf((t*9)+4);
          String Field5=String.valueOf((t*9)+5);	String Field6=String.valueOf((t*9)+6);
          String Field7=String.valueOf((t*9)+7);        String Field8=String.valueOf((t*9)+8);
          String Field9=String.valueOf((t*9)+9);
	...
	String Status=DRs.getString("FD_Data"+Field8).split(",")[0].trim();
	...
	String Reson=DRs.getString("FD_Data"+Field9);
	String Survey1=DRs.getString("FD_Data46").split(",")[0].trim();
	String Survey2=DRs.getString("FD_Data47").split(",")[0].trim();
	String Survey3=DRs.getString("FD_Data48").split(",")[0].trim();
	String Survey4=DRs.getString("FD_Data49").split(",")[0].trim();
	String Survey5=DRs.getString("FD_Data50").split(",")[0].trim();
