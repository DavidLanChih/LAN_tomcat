...
{
	fw.write("Transfer.jsp 表單:"+FDId+" 錯誤訊息:"+catch_e+catch_ex+catch_exc+"\r\n");
}
else
{
	fw.write(Record_All);		
...
if(catch_e!=""||catch_ex!=""||catch_exc!="")
{
	SqlStr="insert into Flow_Log (L_FormName,L_ActiveType,L_FormMemo) values ('櫃號轉移表單-JFlow_Form_279','批次轉入','錯誤: Transfer.jsp  FR_DataId="+catch_e+catch_ex+catch_exc+"')";
	Data.ExecUpdateSql(Conn,SqlStr);
