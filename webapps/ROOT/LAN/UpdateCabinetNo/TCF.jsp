...
try
{
	...
	/*CHANGE_GOODS資料更新*/
	SqlStrEC1="update CHANGE_GOODS set COUNTER_ID='11081'where COUNTER_ID='11069'";                         //櫃號11069換至11081
	stmt.executeUpdate(SqlStrEC1);
				
	/*GOODS_COUNTER資料更新*/
	SqlStrEC2="update GOODS_COUNTER set COUNTER_ID='11081'where COUNTER_ID='11069'";                        //櫃號11069換至11081
