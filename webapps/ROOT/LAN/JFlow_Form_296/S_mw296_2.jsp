			...
			try
			{
				...
				if(!FD_Data1.equals(""))                                                 
				{
					...
					for(int t=0;t<TransferGroup;t++)                                                             //t的參數=第幾組(0=第一組,1=第二組，類推)->參數由TransferGroup動態取值             
					{
						...
						if(!FD_Data3.equals("")) 
						{
							...
							if(days<=0)
							{
								...
								String p027_active="1";                                   //櫃號狀態 (1:撤櫃生效, 0:撤櫃失效)
								...
								String p027_kuser=applyman[0];                            //申請人
					...
					try
					{
						...
						String CC = "cy7022@mail2.chungyo.com.tw,cy6909@mail2.chungyo.com.tw,cy6213@mail2.chungyo.com.tw";   // 接受人郵件地址(副本)
...
if(catch_e!=""||catch_ex!=""||catch_d!="")
{
	...
	String cc = "cy6909@mail2.chungyo.com.tw,cy6213@mail2.chungyo.com.tw";                                                            		 // 接受人郵件地址(副本)
