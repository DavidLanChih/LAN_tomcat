...
SqlStr="select top 1 FD_Data3 from flow_formdata INNER JOIN flow_form_rulestage ON flow_formdata.FD_RecId = flow_form_rulestage.FR_DataId where FD_Data3 like N'CA%' and FD_Data2 like N'"+strDate+"%' ORDER BY FD_Data3 DESC";  
//SqlStr="select top 1 FD_Data3 from flow_formdata where FD_Data3 like N'CA%' and FD_Data2 like N'2014/09%' ORDER BY FD_Data4 DESC";  

Rs=Data.getSmt(Conn,SqlStr);
if(Rs.next())
{ss= String.format("%03d",Integer.valueOf(Rs.getString("FD_Data3").substring(9))+y); }
else
