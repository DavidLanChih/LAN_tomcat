...
String FDept1=USID.substring(2,3);
...
if(FDept.equals("66"))
{
	p014_divno="p020_line='6'";
	p031_div="p020_line='6'";
}
else if(FDept.equals("76"))
{
	p014_divno="p020_line='7'";
	p031_div="p020_line='7'";
}
...
{
	p014_divno="p020_line='"+FDept1+"'";
	p031_div="p020_line='"+FDept1+"'";
}
...
else
{
	...
	SqlStr="select p014_speno as speno,p014_sname as sname,p014_blane as blane,p014_divno as divno "+
	"from cy@chyusc1:purf014,purf020 "+
	"where length(p014_speno)=5 and "+p014_divno+" and purf014.p014_divno=purf020.p020_div and (p014_out is null or p014_out >=today -30) and p014_end >=today -30 "+
	"union select p031_box as speno,p031_mark as sname,p031_blane as blane,p031_div as divno "+
	"from purf031,purf020 "+
	"where length(p031_box)=5 and "+p031_div+" and purf031.p031_div=purf020.p020_div  and (p031_out is null or p031_out >=today -30)" ;
}
