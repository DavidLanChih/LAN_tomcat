...
SqlStr="select * from flow_formdata,flow_form_rulestage where flow_form_rulestage.FR_FormAP='JFlow_Form_146' and flow_form_rulestage.FR_FinishState!=2 and flow_form_rulestage.FR_FinishState!=3 and flow_formdata.FD_RecId=flow_form_rulestage.FR_DataId  and SUBSTRING(FD_Data4,1,10)='"+USerno+"' and SUBSTRING(FD_Data5,1,1)='"+Serno1+"' ";
