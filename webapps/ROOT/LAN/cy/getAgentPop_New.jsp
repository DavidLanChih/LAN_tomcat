...
String start_yy=req("start_yy",request);
String start_mm=req("start_mm",request);
String start_dd=req("start_dd",request);
...
function closeWindow()
{
	...
	{
		document.getElementById('FrmTemp').src='/cy/CheckId_New.jsp?UID='+no+'&start_yy='+yy+'&start_mm='+mm+'&start_dd='+dd;
