...
SqlStr="select ms07_no from  manfs07 where ms07_condition='N' and ms07_no='"+mw07no+"' and year(ms07_ymd1)='"+mw07yy+"' and month(ms07_ymd1)='"+mw07mm+"' and day(ms07_ymd1) = '"+mw07dd+"' ";   
