...
try
{
	...
	else
	{
		...
		%>    
				...
				o.text = "<%=rs.getString("m013_dd"+Day)+":"+rs.getString("m019_name").trim()+"("+rs.getString("m019_hh1")+":"+(rs.getString("m019_mm1").length()==1?"0":"")+rs.getString("m019_mm1")+"~"+rs.getString("m019_hh2")+":"+(rs.getString("m019_mm2").length()==1?"0":"")+rs.getString("m019_mm2")+")"+" 時數:"+rs.getString("m019_thh")+"小時:" +"排休別:"+rs.getString("m013_brk_kind")+":"+rs.getString("m019_abc")  %>";
			  //o.text = "<%=rs.getString("m013_dd"+Day)+":"+rs.getString("m019_name").trim()+"("+rs.getString("m019_hh1")+":"+(rs.getString("m019_mm1").length()==1?"0":"")+rs.getString("m019_mm1")+"~"+rs.getString("m019_hh2")+":"+(rs.getString("m019_mm2").length()==1?"0":"")+rs.getString("m019_mm2")+")"+"排休別:"+rs.getString("m013_brk_kind")+":"+rs.getString("m019_abc")%>";
