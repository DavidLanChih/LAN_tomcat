...
Grid.AddRow("");
Grid.AddCol("(如下拉選單中無所需代理人，<br>請輸入四碼工號)<br><input type=text size='6' name=no onKeyDown='if(event.keyCode==13) closeWindow();'>","colspan=2 align=center");
Grid.AddRow("");
...
function closeWindow()
{
	...
	var AgentID;
	AgentID = document.getElementById('user').value.split(" ")[0];
	
		
	if(document.getElementById('user').value!='')
	{
		
		document.getElementById('FrmTemp1').src='/cy/CheckId3.jsp?UID='+AgentID+'&yyy='+yyy+'&mmm='+mmm+'&ddd='+ddd;
		//document.getElementById('FrmTemp1').src='/cy/CheckId3.jsp?UID='+AgentID;
	  //alert(document.getElementById('FrmTemp1').src);
	  alert("請確認代理人的班表");
	...
	else
	{
		...
		{
			opener.document.getElementById('<%=Field%>').value=document.getElementById('user').options.value.trim() +":"+mmm+"/"+ddd+"班表:";
			window.close();
		}
	}
}
