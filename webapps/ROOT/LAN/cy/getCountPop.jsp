...
Grid.setForm(true); 
Grid.AddTab("專櫃人員刷卡編號",1);
Grid.AddRestTab("");
Grid.AddRow("");
Grid.AddCol("(請輸入7碼刷卡編號)<br><input type=text size='7' name='no' id='no'  onKeyDown='if(event.keyCode==13) closeWindow();'>","colspan=2 align=center");
Grid.AddRow("");
...
function closeWindow()
{
	...
	{
		document.getElementById('FrmTemp').src='/cy/CheckCountId.jsp?UID='+no;
