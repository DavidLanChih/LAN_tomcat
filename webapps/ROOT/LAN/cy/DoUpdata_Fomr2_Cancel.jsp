...
//,mw07_condition 狀態,申請
   ...
   for(int t=0;t<5;t++)
   {
        String Field1=String.valueOf((t*8)+1);	
		String Field2=String.valueOf((t*8)+2);
        String Field3=String.valueOf((t*8)+3);	
		String Field4=String.valueOf((t*8)+4);
        String Field5=String.valueOf((t*8)+5);	
		String Field6=String.valueOf((t*8)+6);
        String Field7=String.valueOf((t*8)+7);  
		String Field8=String.valueOf((t*8)+8);
