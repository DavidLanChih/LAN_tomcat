...
Grid.AddRestTab("");
Grid.AddRow("");
Grid.AddCol("(請輸入廠商編號)<br><input type=text size='5' name='no' id='no'   onKeyDown='if(event.keyCode==13) closeWindow();'>","colspan=2 align=center");
Grid.AddRow("");
...
function closeWindow()
{
	...
	if(document.getElementById('no').value!='')
	{
		...
		document.getElementById('FrmTemp').src='/cy/CheckCountData2.jsp?UID='+no;
