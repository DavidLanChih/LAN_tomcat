<%@page import="leeten.*" %><%@ include file="/cykernel.jsp" %><%@page contentType="text/xml; charset=big5"%><%@ include file="/Modules/JEIPKernel/Util_IO.jsp" %><%@ include file="/Modules/JEIPKernel/Util_Data.jsp" %><%@page import="java.net.*,java.net.URLEncoder" %><%@ page pageEncoding="big5"%><%
NoCatch(response);
...
//,mw07_condition 狀態,申請
   ...
   for(int t=0;t<5;t++)
   {
        ...
        if(!ApplyUser.equals(""))
        {
			...
			SqlStr+="mw07_boss1,mw07_confirm1,mw07_boss2,mw07_confirm2,mw07_boss3,mw07_confirm3,mw07_billno,mw07_boss_billno,mw07_boss_date,mw07_boss_time) values (";
