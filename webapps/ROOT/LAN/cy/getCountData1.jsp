...
Grid.AddRestTab("");
Grid.AddRow("");
Grid.AddCol("(請輸入專櫃號碼)<br><input type=text size='7' name='no' id='no'   onKeyDown='if(event.keyCode==13) closeWindow();'>","colspan=2 align=center");
Grid.AddRow("");
...
function closeWindow()
{
	...
	{
		document.getElementById('FrmTemp').src='/cy/CheckCountData1.jsp?UID='+no;
	}
	else
	{
