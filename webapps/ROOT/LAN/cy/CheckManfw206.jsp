...
SqlStr="select m073_boss,m073_dept from manf073 where m073_code ='1' and m073_dept='"+UID1+"'";
Rs=stmt.executeQuery(SqlStr);
if(Rs.next())
{ 
	p039_qty=Rs.getString("m073_dept").trim()+Rs.getString("m073_boss").trim()+" ";
...
if(Rs.next())
{ 
	p039_val=Rs.getString("m073_dept")+Rs.getString("m073_boss")+","+Rs.getString("m073_dept")+Rs.getString("m001_dname")+":"+Rs.getString("m073_boss")+Rs.getString("m002_name").trim();
}
Rs.close();Rs=null;
...
SqlStr="select m073_big_boss,m073_dept from manf073 where m073_code ='1' and m073_dept='"+UID1+"'";
Rs=stmt.executeQuery(SqlStr);
if(Rs.next())
{ 
	...
	if(Rs.getString("m073_big_boss")!=null)
	{
		...
		{
			p046_qty=Rs.getString("m073_dept")+Rs.getString("m073_big_boss").trim()+" ";
...
if(Rs.next())
{ 
	p046_qty=Rs.getString("m073_dept")+Rs.getString("m073_boss");
	p046_val=Rs.getString("m073_dept")+Rs.getString("m073_boss")+","+Rs.getString("m073_dept")+Rs.getString("m001_dname")+":"+Rs.getString("m073_boss")+Rs.getString("m002_name").trim();
}
Rs.close();Rs=null;
...
//out.print(SqlStr+"<br>");
//out.print(p039_qty+"<br>");
//out.print(p046_qty+"<br>");
//out.print(p039_val+"<br>");
//out.print(p046_val+"<br>");
%>
