...
SqlStr="select m035_no,m035_name,m035_adate,YEAR(m035_adate) as m035_yyyy,MONTH(m035_adate) as m035_mm,DAY(m035_adate) as m035_dd from  manf035 where  manf035.m035_no='"+UIDD+"'";   
...
<script language="javascript">	
	parent.document.getElementById('no').value='<%=m035No%>'+':'+'<%=m035Name%>';
