...
function doApply()
{
	var p2=parseInt(Frm.FD_Data2.value);
	var p3=parseInt(Frm.FD_Data3.value);
	var p4=parseInt(Frm.FD_Data4.value);
	var p5=parseInt(Frm.FD_Data5.value);
	var p6=parseInt(Frm.FD_Data6.value);

	Frm.FD_Data8.value=p2+p3+p4+p5+p6;
	if(Frm.FD_Data8.value>=13)
	{
		Frm.FD_Data9.value='3';
	}
	else if (Frm.FD_Data8.value>=10)
	{
		Frm.FD_Data9.value='2';
	}
	else if (Frm.FD_Data8.value>=7)
	{
		Frm.FD_Data9.value='1';
	}
	else
	{
		Frm.FD_Data9.value='0';
	}
    if(DataCheck())
    {
