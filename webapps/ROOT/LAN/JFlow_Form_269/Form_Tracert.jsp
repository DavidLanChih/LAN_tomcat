...
String SqlStr="",OP="",Site="Form_Tracert.jsp",ReApply="",CancelStr="",FormName="",ScriptStr="";
String FI_RecId="",FR_RecId="",FinishTime="",DrawFunctionStr="",DeleteFunction="",FieldCountArr[]=null;
int RI_DrawForm=0;
...
if(OP.equals("DelDraw"))
{
    FR_RecId=req("FR_RecId",request);   
    SqlStr="delete from flow_form_rulestage where FR_FinishState=3 and FR_RecId="+Data.toSql(FR_RecId)+" and FR_OrgId="+J_OrgId;
    Data.ExecUpdateSql(Conn,SqlStr);
    OP="ReloadTree";
}
...
Grid.setSearch(1);
Grid.AddTab("<img src='/Modules/JFlow_FormWizard/Form_Tracert.gif'>&nbsp;表單追蹤",1);
...
<script>
function ReApplyViewForm(FI_RecId,FD_RecId)
{
    document.getElementById('FrmTemp').src='/Modules/<%=SysCurrModuleId%>/Form_Apply_Content.jsp?OP=ReApply&FI_RecId='+FI_RecId+'&FD_RecId='+FD_RecId;   
}
